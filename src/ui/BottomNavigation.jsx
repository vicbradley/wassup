...
export const BottomNavigation = () => {
    ...
    const resetDisplay = () => {
        ...
        setIsFriendMenuActive(false);
        setIsSettingActive(false);
    }
    
    const setDisplay = (displayType) => {
        resetDisplay();
    ...
    return (
        <div className="btm-nav">
            <button className={isChatMenuActive ? "active" : ""} onClick={() => setDisplay("chat")}>
            ...
            <button className={isFriendMenuActive ? "active" : ""} onClick={() => setDisplay("friends")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            <button className={isSettingActive ? "active" : ""} onClick={() => setDisplay("setting")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
